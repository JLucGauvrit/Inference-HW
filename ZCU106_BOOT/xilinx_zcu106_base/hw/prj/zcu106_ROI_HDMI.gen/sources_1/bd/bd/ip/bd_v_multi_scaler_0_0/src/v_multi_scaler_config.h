...
#else
#define HSC_ARRAY_SIZE            ((((HSC_TAPS/2)+1+HSC_SAMPLES_PER_CLOCK-1)/HSC_SAMPLES_PER_CLOCK + 2)*HSC_SAMPLES_PER_CLOCK + (HSC_TAPS/2) - 1)  // if the HSC_ARRAY_SIZE is not a factor of HSC_MAX_SMPLS_PERCLK, then need to make it to be factor of HSC_MAX_SMPLS_PERCLK
#endif
