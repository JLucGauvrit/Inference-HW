...
################################################################
# This is a generated script based on design: bd_82bb
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net net_v_hdmi_tx_bridge_yuv420 [get_bd_pins v_axi4s_vid_out/remap_420_en] [get_bd_pins v_hdmi_tx/bridge_yuv420]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_AXI_CPU_IN] [get_bd_addr_segs v_hdmi_tx/S_AXI/reg0] -force
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_AXI_CPU_IN] [get_bd_addr_segs v_tc/ctrl/Reg] -force
