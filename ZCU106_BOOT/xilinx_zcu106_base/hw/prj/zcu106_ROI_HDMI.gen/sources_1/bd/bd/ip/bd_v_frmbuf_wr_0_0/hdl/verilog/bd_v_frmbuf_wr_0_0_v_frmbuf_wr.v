...
(* CORE_GENERATION_INFO="bd_v_frmbuf_wr_0_0_v_frmbuf_wr,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.433090,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=24,HLS_SYN_DSP=0,HLS_SYN_FF=5326,HLS_SYN_LUT=6478,HLS_VERSION=2020_2}" *)

module bd_v_frmbuf_wr_0_0_v_frmbuf_wr (
        ap_clk,
        ap_rst_n,
...
wire   [5:0] empty_65_fu_187_p1;
reg   [5:0] empty_65_reg_218;
wire   [11:0] empty_fu_197_p1;
reg   [11:0] empty_reg_233;
wire    ap_CS_fsm_state2;
reg   [2:0] BYTES_PER_PIXEL_load_reg_239;
reg   [2:0] colorFormat_reg_244;
wire   [14:0] WidthInBytes_fu_207_p2;
reg   [14:0] WidthInBytes_reg_249;
wire    ap_CS_fsm_state3;
reg   [63:0] frm_buffer2_read_reg_254;
wire    ap_CS_fsm_state4;
reg   [63:0] frm_buffer_read_reg_259;
wire   [11:0] empty_66_fu_213_p1;
reg   [11:0] empty_66_reg_269;
wire    grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWVALID;
wire   [63:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WVALID;
wire   [127:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WDATA;
wire   [15:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WSTRB;
wire    grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WLAST;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WID;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARVALID;
wire   [63:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_RREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_BREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_156_s_axis_video_TREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_156_ap_start;
wire    grp_FrmbufWrHlsDataFlow_fu_156_ap_done;
wire    grp_FrmbufWrHlsDataFlow_fu_156_ap_ready;
wire    grp_FrmbufWrHlsDataFlow_fu_156_ap_idle;
reg    grp_FrmbufWrHlsDataFlow_fu_156_ap_continue;
reg    grp_FrmbufWrHlsDataFlow_fu_156_ap_start_reg;
wire    ap_CS_fsm_state5;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_done;
reg    ap_block_state5_on_subcall_done;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_done;
wire   [63:0] zext_ln151_fu_191_p1;
wire   [11:0] WidthInBytes_fu_207_p0;
...
wire   [14:0] WidthInBytes_fu_207_p00;
wire   [14:0] WidthInBytes_fu_207_p10;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 ap_CS_fsm = 5'd1;
#0 grp_FrmbufWrHlsDataFlow_fu_156_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_done = 1'b0;
end

bd_v_frmbuf_wr_0_0_BYTES_PER_PIXEL #(
    .DataWidth( 3 ),
    .AddressRange( 40 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
bd_v_frmbuf_wr_0_0_MEMORY2LIVE #(
    .DataWidth( 3 ),
    .AddressRange( 40 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
bd_v_frmbuf_wr_0_0_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_DW( 128 ),
    .USER_AW( 64 ),
    .USER_MAXREQS( 105 ),
...
mm_video_m_axi_U(
    ...
    .I_AWADDR(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWADDR),
    .I_AWID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWID),
    .I_AWLEN(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWLEN),
    .I_AWSIZE(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWSIZE),
    .I_AWLOCK(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWLOCK),
    .I_AWCACHE(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWCACHE),
    .I_AWQOS(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWQOS),
    .I_AWPROT(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWPROT),
    .I_AWUSER(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWUSER),
    .I_AWBURST(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWBURST),
    .I_AWREGION(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWREGION),
    .I_WVALID(mm_video_WVALID),
    .I_WREADY(mm_video_WREADY),
    .I_WDATA(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WDATA),
    .I_WID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WID),
    .I_WUSER(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WUSER),
    .I_WLAST(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WLAST),
    .I_WSTRB(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WSTRB),
...
bd_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_156(
    .m_axi_mm_video_AWVALID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWVALID),
    .m_axi_mm_video_AWREADY(mm_video_AWREADY),
    .m_axi_mm_video_AWADDR(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWADDR),
    .m_axi_mm_video_AWID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWID),
    .m_axi_mm_video_AWLEN(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWLEN),
    .m_axi_mm_video_AWSIZE(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWSIZE),
    .m_axi_mm_video_AWBURST(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWBURST),
    .m_axi_mm_video_AWLOCK(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWLOCK),
    .m_axi_mm_video_AWCACHE(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWCACHE),
    .m_axi_mm_video_AWPROT(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWPROT),
    .m_axi_mm_video_AWQOS(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWQOS),
    .m_axi_mm_video_AWREGION(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWREGION),
    .m_axi_mm_video_AWUSER(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWUSER),
    .m_axi_mm_video_WVALID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WVALID),
    .m_axi_mm_video_WREADY(mm_video_WREADY),
    .m_axi_mm_video_WDATA(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WDATA),
    .m_axi_mm_video_WSTRB(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WSTRB),
    .m_axi_mm_video_WLAST(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WLAST),
    .m_axi_mm_video_WID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WID),
    .m_axi_mm_video_WUSER(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WUSER),
    .m_axi_mm_video_ARVALID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARVALID),
    .m_axi_mm_video_ARREADY(1'b0),
    .m_axi_mm_video_ARADDR(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARADDR),
    .m_axi_mm_video_ARID(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARID),
    .m_axi_mm_video_ARLEN(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARLEN),
    .m_axi_mm_video_ARSIZE(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARSIZE),
    .m_axi_mm_video_ARBURST(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARBURST),
    .m_axi_mm_video_ARLOCK(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARLOCK),
    .m_axi_mm_video_ARCACHE(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARCACHE),
    .m_axi_mm_video_ARPROT(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARPROT),
    .m_axi_mm_video_ARQOS(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARQOS),
    .m_axi_mm_video_ARREGION(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARREGION),
    .m_axi_mm_video_ARUSER(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_ARUSER),
    .m_axi_mm_video_RVALID(1'b0),
    .m_axi_mm_video_RREADY(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_RREADY),
    ...
    .m_axi_mm_video_BREADY(grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_BREADY),
    ...
    .HwReg_frm_buffer(frm_buffer_read_reg_259),
    .HwReg_frm_buffer2(frm_buffer2_read_reg_254),
    .p_read(WidthInBytes_reg_249),
    .p_read1(colorFormat_reg_244),
    .p_read2(empty_reg_233),
    .p_read3(empty_66_reg_269),
    .p_read4(stride),
    .p_read5(empty_65_reg_218),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .s_axis_video_TVALID(s_axis_video_TVALID_int_regslice),
    .s_axis_video_TREADY(grp_FrmbufWrHlsDataFlow_fu_156_s_axis_video_TREADY),
    .p_read3_ap_vld(1'b1),
    .p_read2_ap_vld(1'b1),
    .p_read1_ap_vld(1'b1),
    ...
    .p_read4_ap_vld(1'b1),
    .p_read5_ap_vld(1'b1),
    .ap_start(grp_FrmbufWrHlsDataFlow_fu_156_ap_start),
    .ap_done(grp_FrmbufWrHlsDataFlow_fu_156_ap_done),
    .ap_ready(grp_FrmbufWrHlsDataFlow_fu_156_ap_ready),
    .ap_idle(grp_FrmbufWrHlsDataFlow_fu_156_ap_idle),
    .ap_continue(grp_FrmbufWrHlsDataFlow_fu_156_ap_continue)
);

bd_v_frmbuf_wr_0_0_mul_12ns_3ns_15_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 12 ),
    .din1_WIDTH( 3 ),
    .dout_WIDTH( 15 ))
mul_12ns_3ns_15_1_1_U79(
    .din0(WidthInBytes_fu_207_p0),
    .din1(WidthInBytes_fu_207_p1),
    .dout(WidthInBytes_fu_207_p2)
);

bd_v_frmbuf_wr_0_0_regslice_both #(
    .DataWidth( 48 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_done <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_156_ap_done == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_156_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_FrmbufWrHlsDataFlow_fu_156_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state4) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state5)))) begin
            grp_FrmbufWrHlsDataFlow_fu_156_ap_start_reg <= 1'b1;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_156_ap_ready == 1'b1)) begin
            grp_FrmbufWrHlsDataFlow_fu_156_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        empty_reg_233 <= empty_fu_197_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        WidthInBytes_reg_249 <= WidthInBytes_fu_207_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_65_reg_218 <= empty_65_fu_187_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        empty_66_reg_269 <= empty_66_fu_213_p1;
        frm_buffer2_read_reg_254 <= frm_buffer2;
        frm_buffer_read_reg_259 <= frm_buffer;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
        grp_FrmbufWrHlsDataFlow_fu_156_ap_continue = 1'b1;
    end else begin
        grp_FrmbufWrHlsDataFlow_fu_156_ap_continue = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4))) begin
        mm_video_AWVALID = grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_AWVALID;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4))) begin
        mm_video_BREADY = grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_BREADY;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4))) begin
        mm_video_WVALID = grp_FrmbufWrHlsDataFlow_fu_156_m_axi_mm_video_WVALID;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        s_axis_video_TREADY_int_regslice = grp_FrmbufWrHlsDataFlow_fu_156_s_axis_video_TREADY;
    end else begin
...
assign BYTES_PER_PIXEL_address0 = zext_ln151_fu_191_p1;

assign MEMORY2LIVE_address0 = zext_ln151_fu_191_p1;

assign WidthInBytes_fu_207_p0 = WidthInBytes_fu_207_p00;

assign WidthInBytes_fu_207_p00 = empty_reg_233;

assign WidthInBytes_fu_207_p1 = WidthInBytes_fu_207_p10;

assign WidthInBytes_fu_207_p10 = BYTES_PER_PIXEL_load_reg_239;
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready & ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_done) == 1'b0);
end
...
assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_done = (grp_FrmbufWrHlsDataFlow_fu_156_ap_done | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_done);

assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready = (grp_FrmbufWrHlsDataFlow_fu_156_ap_ready | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_156_ap_ready);

assign empty_65_fu_187_p1 = video_format[5:0];

assign empty_66_fu_213_p1 = height[11:0];

assign empty_fu_197_p1 = width[11:0];

assign grp_FrmbufWrHlsDataFlow_fu_156_ap_start = grp_FrmbufWrHlsDataFlow_fu_156_ap_start_reg;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign zext_ln151_fu_191_p1 = video_format;


// synthesis translate_off
`include "bd_v_frmbuf_wr_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

endmodule //bd_v_frmbuf_wr_0_0_v_frmbuf_wr
