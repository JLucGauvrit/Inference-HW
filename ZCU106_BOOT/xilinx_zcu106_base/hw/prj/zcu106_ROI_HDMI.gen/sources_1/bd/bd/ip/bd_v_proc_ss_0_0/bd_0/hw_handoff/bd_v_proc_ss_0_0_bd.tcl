...
################################################################
# This is a generated script based on design: bd_c2dc
#
...
proc create_root_design { parentCell } {
  ...
  set hsc [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_hscaler:1.1 hsc ]
  set_property -dict [ list \
   CONFIG.ENABLE_420 {1} \
   CONFIG.ENABLE_422 {1} \
   CONFIG.ENABLE_CSC {1} \
  ...
  set vsc [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_vscaler:1.1 vsc ]
  set_property -dict [ list \
   CONFIG.ENABLE_420 {1} \
   CONFIG.MAX_COLS {3840} \
   CONFIG.MAX_DATA_WIDTH {8} \
