...
module bd_v_mix_0_0_AXIMMvideo2Bytes_2_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        bytesLayer2_plane0_din,
        bytesLayer2_plane0_full_n,
        bytesLayer2_plane0_write,
        bytesLayer2_plane1_din,
        bytesLayer2_plane1_full_n,
        bytesLayer2_plane1_write,
        HwReg_layer2_buf1_dout,
        HwReg_layer2_buf1_empty_n,
        HwReg_layer2_buf1_read,
        HwReg_layer2_buf2_dout,
        HwReg_layer2_buf2_empty_n,
        HwReg_layer2_buf2_read,
...
output  [127:0] bytesLayer2_plane0_din;
input   bytesLayer2_plane0_full_n;
output   bytesLayer2_plane0_write;
output  [127:0] bytesLayer2_plane1_din;
input   bytesLayer2_plane1_full_n;
output   bytesLayer2_plane1_write;
input  [63:0] HwReg_layer2_buf1_dout;
input   HwReg_layer2_buf1_empty_n;
output   HwReg_layer2_buf1_read;
input  [63:0] HwReg_layer2_buf2_dout;
input   HwReg_layer2_buf2_empty_n;
output   HwReg_layer2_buf2_read;
...
input  [15:0] p_read57_dout;
input   p_read57_empty_n;
output   p_read57_read;
...
reg ap_idle;
reg start_write;
reg m_axi_mm_video2_ARVALID;
reg[63:0] m_axi_mm_video2_ARADDR;
reg m_axi_mm_video2_RREADY;
reg bytesLayer2_plane0_write;
reg bytesLayer2_plane1_write;
reg HwReg_layer2_buf1_read;
reg HwReg_layer2_buf2_read;
...
reg    mm_video2_blk_n_AR;
wire    ap_CS_fsm_state7;
reg    mm_video2_blk_n_R;
...
reg    HwReg_layer2_buf1_blk_n;
reg    HwReg_layer2_buf2_blk_n;
...
reg   [12:0] x_reg_239;
reg   [12:0] x_24_reg_250;
reg   [63:0] HwReg_layer2_buf1_read_reg_448;
reg   [63:0] HwReg_layer2_buf2_read_reg_453;
reg   [15:0] HwReg_layerHeight17_load_loc_read_reg_458;
wire   [0:0] p_read_58_read_fu_162_p2;
reg   [0:0] p_read_58_reg_464;
reg   [12:0] loopWidth_reg_468;
reg   [11:0] div5_i_i_reg_476;
wire   [31:0] loopWidth_cast5_i_i_fu_294_p1;
reg   [31:0] loopWidth_cast5_i_i_reg_482;
...
wire   [15:0] y_25_fu_318_p2;
reg   [15:0] y_25_reg_513;
wire    ap_CS_fsm_state3;
wire   [0:0] trunc_ln56_fu_324_p1;
reg   [0:0] trunc_ln56_reg_518;
wire   [0:0] icmp_ln56_2_fu_328_p2;
reg   [59:0] trunc_ln_reg_530;
wire    ap_CS_fsm_state6;
wire   [12:0] add_ln62_2_fu_373_p2;
...
reg   [59:0] trunc_ln2_reg_555;
wire    ap_CS_fsm_state116;
wire   [12:0] add_ln72_2_fu_421_p2;
...
wire  signed [63:0] sext_ln72_2_fu_411_p1;
reg   [31:0] offsetUV_fu_128;
wire   [31:0] offsetUV_2_fu_432_p2;
reg    ap_block_state1;
...
wire   [63:0] zext_ln62_4_fu_344_p1;
wire   [63:0] add_ln62_fu_348_p2;
wire   [35:0] shl_ln2_fu_384_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state3) & ((p_read_58_reg_464 == 1'd0) | ((icmp_ln56_2_fu_328_p2 == 1'd1) | (icmp_ln56_reg_493 == 1'd1))))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln56_fu_300_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        offsetUV_fu_128 <= offsetUV_2_fu_432_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state222)) begin
        ...
        x_24_reg_250 <= add_ln72_2_fu_421_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state112)) begin
        ...
        x_reg_239 <= add_ln62_2_fu_373_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln56_fu_300_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        y_reg_228 <= y_25_reg_513;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        HwReg_layer2_buf1_read_reg_448 <= HwReg_layer2_buf1_dout;
        HwReg_layer2_buf2_read_reg_453 <= HwReg_layer2_buf2_dout;
        HwReg_layerHeight17_load_loc_read_reg_458 <= HwReg_layerHeight17_load_loc_dout;
        p_read_58_reg_464 <= p_read2_dout;
    end
end
...
always @ (posedge ap_clk) begin
    if (((p_read_58_read_fu_162_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        div5_i_i_reg_476 <= {{p_read57_dout[15:4]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        loopWidth_cast5_i_i_reg_482[12 : 0] <= loopWidth_cast5_i_i_fu_294_p1[12 : 0];
...
always @ (posedge ap_clk) begin
    if (((trunc_ln56_reg_518 == 1'd0) & (cmp21_i_i_reg_504 == 1'd1) & (1'b1 == ap_CS_fsm_state116))) begin
        trunc_ln2_reg_555 <= {{add_ln72_fu_396_p2[63:4]}};
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln56_reg_493 == 1'd0) & (p_read_58_reg_464 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        trunc_ln56_reg_518 <= trunc_ln56_fu_324_p1;
        y_25_reg_513 <= y_25_fu_318_p2;
    end
end
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_layer2_buf1_blk_n = HwReg_layer2_buf1_empty_n;
    end else begin
        HwReg_layer2_buf1_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((p_read2_out_full_n == 1'b0) | (layer2WidthInBytes_loc_out_full_n == 1'b0) | (p_read2_empty_n == 1'b0) | (p_read57_empty_n == 1'b0) | (layer2WidthInBytes_loc_empty_n == 1'b0) | (1'b0 == HwReg_layerHeight17_load_loc_out_full_n) | (1'b0 == HwReg_layerHeight17_load_loc_empty_n) | (1'b0 == HwReg_layer2_buf2_empty_n) | (1'b0 == HwReg_layer2_buf1_empty_n) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_layer2_buf1_read = 1'b1;
    end else begin
        HwReg_layer2_buf1_read = 1'b0;
    end
end

always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_layer2_buf2_blk_n = HwReg_layer2_buf2_empty_n;
    end else begin
        HwReg_layer2_buf2_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((p_read2_out_full_n == 1'b0) | (layer2WidthInBytes_loc_out_full_n == 1'b0) | (p_read2_empty_n == 1'b0) | (p_read57_empty_n == 1'b0) | (layer2WidthInBytes_loc_empty_n == 1'b0) | (1'b0 == HwReg_layerHeight17_load_loc_out_full_n) | (1'b0 == HwReg_layerHeight17_load_loc_empty_n) | (1'b0 == HwReg_layer2_buf2_empty_n) | (1'b0 == HwReg_layer2_buf1_empty_n) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_layer2_buf2_read = 1'b1;
    end else begin
        HwReg_layer2_buf2_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & ((p_read_58_reg_464 == 1'd0) | ((icmp_ln56_2_fu_328_p2 == 1'd1) | (icmp_ln56_reg_493 == 1'd1))))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln62_reg_546_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        bytesLayer2_plane0_blk_n = bytesLayer2_plane0_full_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln62_reg_546_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        bytesLayer2_plane0_write = 1'b1;
    end else begin
        bytesLayer2_plane0_write = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln72_reg_571_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (1'b0 == ap_block_pp1_stage0))) begin
        bytesLayer2_plane1_blk_n = bytesLayer2_plane1_full_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln72_reg_571_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        bytesLayer2_plane1_write = 1'b1;
    end else begin
        bytesLayer2_plane1_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((m_axi_mm_video2_ARREADY == 1'b1)) begin
        if ((1'b1 == ap_CS_fsm_state117)) begin
            m_axi_mm_video2_ARADDR = sext_ln72_2_fu_411_p1;
        end else if ((1'b1 == ap_CS_fsm_state7)) begin
            m_axi_mm_video2_ARADDR = sext_ln62_fu_363_p1;
        end else begin
            m_axi_mm_video2_ARADDR = 'bx;
        end
    end else begin
        m_axi_mm_video2_ARADDR = 'bx;
    end
...
always @ (*) begin
    if ((((m_axi_mm_video2_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state117)) | ((m_axi_mm_video2_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state7)))) begin
        m_axi_mm_video2_ARVALID = 1'b1;
    end else begin
        m_axi_mm_video2_ARVALID = 1'b0;
    end
end
...
always @ (*) begin
    if ((((icmp_ln72_reg_571 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((icmp_ln62_reg_546 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        m_axi_mm_video2_RREADY = 1'b1;
    end else begin
        m_axi_mm_video2_RREADY = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state117) | (1'b1 == ap_CS_fsm_state7))) begin
        mm_video2_blk_n_AR = m_axi_mm_video2_ARREADY;
    end else begin
        mm_video2_blk_n_AR = 1'b1;
    end
end
...
always @ (*) begin
    if ((((icmp_ln72_reg_571 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((icmp_ln62_reg_546 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        mm_video2_blk_n_R = m_axi_mm_video2_RVALID;
    end else begin
        mm_video2_blk_n_R = 1'b1;
    end
end
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_read57_blk_n = p_read57_empty_n;
    end else begin
        p_read57_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((p_read2_out_full_n == 1'b0) | (layer2WidthInBytes_loc_out_full_n == 1'b0) | (p_read2_empty_n == 1'b0) | (p_read57_empty_n == 1'b0) | (layer2WidthInBytes_loc_empty_n == 1'b0) | (1'b0 == HwReg_layerHeight17_load_loc_out_full_n) | (1'b0 == HwReg_layerHeight17_load_loc_empty_n) | (1'b0 == HwReg_layer2_buf2_empty_n) | (1'b0 == HwReg_layer2_buf1_empty_n) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (p_read_58_read_fu_162_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if ((~((p_read2_out_full_n == 1'b0) | (layer2WidthInBytes_loc_out_full_n == 1'b0) | (p_read2_empty_n == 1'b0) | (p_read57_empty_n == 1'b0) | (layer2WidthInBytes_loc_empty_n == 1'b0) | (1'b0 == HwReg_layerHeight17_load_loc_out_full_n) | (1'b0 == HwReg_layerHeight17_load_loc_empty_n) | (1'b0 == HwReg_layer2_buf2_empty_n) | (1'b0 == HwReg_layer2_buf1_empty_n) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (p_read_58_read_fu_162_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_state7 : begin
            if (((m_axi_mm_video2_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state7))) begin
        ...
        ap_ST_fsm_state117 : begin
            if (((m_axi_mm_video2_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state117))) begin
...
assign WidthInBytes_cast_i_i_fu_264_p1 = layer2WidthInBytes_loc_dout;

assign add_ln62_2_fu_373_p2 = (x_reg_239 + 13'd1);

assign add_ln62_fu_348_p2 = (HwReg_layer2_buf1_read_reg_448 + zext_ln62_4_fu_344_p1);

assign add_ln72_2_fu_421_p2 = (x_24_reg_250 + 13'd1);

assign add_ln72_fu_396_p2 = ($signed(HwReg_layer2_buf2_read_reg_453) + $signed(sext_ln72_fu_392_p1));
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln62_reg_546_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (bytesLayer2_plane0_full_n == 1'b0)) | ((icmp_ln62_reg_546 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_mm_video2_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln62_reg_546_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (bytesLayer2_plane0_full_n == 1'b0)) | ((icmp_ln62_reg_546 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_mm_video2_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln62_reg_546_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (bytesLayer2_plane0_full_n == 1'b0)) | ((icmp_ln62_reg_546 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_mm_video2_RVALID == 1'b0)));
end

assign ap_block_pp1_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp1_stage0_01001 = (((icmp_ln72_reg_571_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (bytesLayer2_plane1_full_n == 1'b0)) | ((icmp_ln72_reg_571 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (m_axi_mm_video2_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((icmp_ln72_reg_571_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (bytesLayer2_plane1_full_n == 1'b0)) | ((icmp_ln72_reg_571 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (m_axi_mm_video2_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((icmp_ln72_reg_571_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (bytesLayer2_plane1_full_n == 1'b0)) | ((icmp_ln72_reg_571 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (m_axi_mm_video2_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((p_read2_out_full_n == 1'b0) | (layer2WidthInBytes_loc_out_full_n == 1'b0) | (p_read2_empty_n == 1'b0) | (p_read57_empty_n == 1'b0) | (layer2WidthInBytes_loc_empty_n == 1'b0) | (1'b0 == HwReg_layerHeight17_load_loc_out_full_n) | (1'b0 == HwReg_layerHeight17_load_loc_empty_n) | (1'b0 == HwReg_layer2_buf2_empty_n) | (1'b0 == HwReg_layer2_buf1_empty_n) | (ap_done_reg == 1'b1) | (real_start == 1'b0));
end

assign ap_block_state113_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state114_pp0_stage0_iter1 = ((icmp_ln62_reg_546 == 1'd0) & (m_axi_mm_video2_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state115_pp0_stage0_iter2 = ((icmp_ln62_reg_546_pp0_iter1_reg == 1'd0) & (bytesLayer2_plane0_full_n == 1'b0));
end

assign ap_block_state223_pp1_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state224_pp1_stage0_iter1 = ((icmp_ln72_reg_571 == 1'd0) & (m_axi_mm_video2_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state225_pp1_stage0_iter2 = ((icmp_ln72_reg_571_pp1_iter1_reg == 1'd0) & (bytesLayer2_plane1_full_n == 1'b0));
end
...
assign bytesLayer2_plane0_din = fb_pix_reg_550;

assign bytesLayer2_plane1_din = fb_pix_2_reg_575;
...
assign icmp_ln56_2_fu_328_p2 = ((y_reg_228 == HwReg_layerHeight17_load_loc_read_reg_458) ? 1'b1 : 1'b0);

assign icmp_ln56_fu_300_p2 = ((HwReg_layerHeight17_load_loc_read_reg_458 == 16'd0) ? 1'b1 : 1'b0);

assign icmp_ln62_fu_379_p2 = ((x_reg_239 == loopWidth_reg_468) ? 1'b1 : 1'b0);

assign icmp_ln72_fu_427_p2 = ((x_24_reg_250 == loopWidth_reg_468) ? 1'b1 : 1'b0);

assign layer2WidthInBytes_loc_out_din = layer2WidthInBytes_loc_dout;

assign loopWidth_cast5_i_i_fu_294_p1 = loopWidth_reg_468;

assign m_axi_mm_video2_ARBURST = 2'd0;

assign m_axi_mm_video2_ARCACHE = 4'd0;

assign m_axi_mm_video2_ARID = 1'd0;

assign m_axi_mm_video2_ARLEN = loopWidth_cast5_i_i_reg_482;

assign m_axi_mm_video2_ARLOCK = 2'd0;

assign m_axi_mm_video2_ARPROT = 3'd0;

assign m_axi_mm_video2_ARQOS = 4'd0;

assign m_axi_mm_video2_ARREGION = 4'd0;

assign m_axi_mm_video2_ARSIZE = 3'd0;

assign m_axi_mm_video2_ARUSER = 1'd0;
...
assign offsetUV_2_fu_432_p2 = (offsetUV_fu_128 + zext_ln56_reg_488);

assign p_read2_out_din = p_read2_dout;

assign p_read_58_read_fu_162_p2 = p_read2_dout;

assign sext_ln62_fu_363_p1 = $signed(trunc_ln_reg_530);

assign sext_ln72_2_fu_411_p1 = $signed(trunc_ln2_reg_555);

assign sext_ln72_fu_392_p1 = $signed(shl_ln2_fu_384_p3);

assign shl_ln2_fu_384_p3 = {{offsetUV_fu_128}, {4'd0}};
...
assign y_25_fu_318_p2 = (y_reg_228 + 16'd1);

assign zext_ln56_fu_297_p1 = div5_i_i_reg_476;

assign zext_ln62_4_fu_344_p1 = shl_ln_fu_337_p3;

assign zext_ln62_fu_310_p1 = div5_i_i_reg_476;

always @ (posedge ap_clk) begin
    loopWidth_cast5_i_i_reg_482[31:13] <= 19'b0000000000000000000;
    zext_ln56_reg_488[31:12] <= 20'b00000000000000000000;
    zext_ln62_reg_508[27:12] <= 16'b0000000000000000;
end

endmodule //bd_v_mix_0_0_AXIMMvideo2Bytes_2_s
