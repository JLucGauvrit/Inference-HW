...
module bd_vid_phy_controller_0_clkdet
#(
...
(
    ...
    input wire   [3:0]  clkdet_ctrl_delta_range,        // Register Interface to adjust the  clk_rx_flt_delta  value within a tolerance range   
...
// RX frequency lock counter
    ...
    begin
        ...
        begin  
            ...
            begin
                // Increment
                if (clk_rx_flt_delta <  clkdet_ctrl_delta_range)
                begin
...
vid_phy_controller_v2_2_7_lib_edge_v1_0
