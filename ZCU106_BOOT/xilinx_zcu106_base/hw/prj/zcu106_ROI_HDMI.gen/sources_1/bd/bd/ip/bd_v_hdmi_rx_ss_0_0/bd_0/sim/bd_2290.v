...
//--------------------------------------------------------------------------------
//Command: generate_target bd_2290.bd
//Design : bd_2290
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_2290,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2290,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bd_v_hdmi_rx_ss_0_0.hwdef" *) 
module bd_2290
   (AUDIO_OUT_tdata,
    AUDIO_OUT_tid,
    AUDIO_OUT_tready,
  ...
  wire [7:0]intf_net_v_hdmi_rx_AUDIO_OUT_TID;
  ...
  assign AUDIO_OUT_tid[7:0] = intf_net_v_hdmi_rx_AUDIO_OUT_TID;
  ...
  bd_2290_inverter_1_0 inverter_1
       (.Op1(net_bdry_in_cable_detect),
        .Res(net_inverter_1_Res));
  bd_2290_v_hdmi_rx_0 v_hdmi_rx
  ...
  bd_2290_v_vid_in_axi4s_0 v_vid_in_axi4s
