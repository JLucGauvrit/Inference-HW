...
// ==============================================================
`timescale 1ns/1ps
module bd_c2dc_hsc_0_CTRL_s_axi
#(parameter
...
// 0x4000 ~
// 0x5fff : Memory 'phasesH' (1920 * 32b)
//          Word n : bit [31:0] - phasesH[n]
...
//------------------------Local signal-------------------
    ...
    wire [10:0]                   int_phasesH_address0;
...
// phasesH
assign int_phasesH_address0   = phasesH_address0;
assign int_phasesH_ce0        = phasesH_ce0;
assign int_phasesH_we0        = 1'b0;
assign int_phasesH_be0        = 1'b0;
assign int_phasesH_d0         = 1'b0;
assign phasesH_q0             = int_phasesH_q0;
assign int_phasesH_address1   = ar_hs? raddr[12:2] : waddr[12:2];
...
module bd_c2dc_hsc_0_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
