...
--               /wrk/paeg1/users/Juneed/VCU/2020_2/ROI/HDMI_ROI/HDMI_ROI_1/pl/build/zcu106_ROI_HDMI/zcu106_ROI_HDMI.gen/sources_1/bd/bd/ip/bd_ibufds_gt_0/bd_ibufds_gt_0_sim_netlist.vhdl
-- Design      : bd_ibufds_gt_0
...
entity bd_ibufds_gt_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of bd_ibufds_gt_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of bd_ibufds_gt_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of bd_ibufds_gt_0_util_ds_buf : entity is "ibufdsgte4";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of bd_ibufds_gt_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of bd_ibufds_gt_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of bd_ibufds_gt_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of bd_ibufds_gt_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bd_ibufds_gt_0_util_ds_buf : entity is "util_ds_buf";
end bd_ibufds_gt_0_util_ds_buf;

architecture STRUCTURE of bd_ibufds_gt_0_util_ds_buf is
  signal \<const0>\ : STD_LOGIC;
  attribute box_type : string;
  attribute box_type of \USE_IBUFDS_GTE4.GEN_IBUFDS_GTE4[0].IBUFDS_GTE4_I\ : label is "PRIMITIVE";
begin
  BUFGCE_O(0) <= \<const0>\;
...
\USE_IBUFDS_GTE4.GEN_IBUFDS_GTE4[0].IBUFDS_GTE4_I\: unisim.vcomponents.IBUFDS_GTE4
    generic map(
      REFCLK_EN_TX_PATH => '0',
...
entity bd_ibufds_gt_0 is
  ...
  attribute NotValidForBitStream of bd_ibufds_gt_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_ibufds_gt_0 : entity is "bd_ibufds_gt_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of bd_ibufds_gt_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of bd_ibufds_gt_0 : entity is "util_ds_buf,Vivado 2020.2";
end bd_ibufds_gt_0;

architecture STRUCTURE of bd_ibufds_gt_0 is
  ...
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of U0 : label is "ibufdsgte4";
  attribute C_OBUFDS_GTE5_ADV : string;
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 156250000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN bd_ibufds_gt_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  attribute x_interface_info of IBUF_DS_P : signal is "xilinx.com:interface:diff_clock:1.0 CLK_IN_D CLK_P";
  attribute x_interface_parameter of IBUF_DS_P : signal is "XIL_INTERFACENAME CLK_IN_D, BOARD.ASSOCIATED_PARAM DIFF_CLK_IN_BOARD_INTERFACE, CAN_DEBUG false, FREQ_HZ 156250000";
  attribute x_interface_info of IBUF_OUT : signal is "xilinx.com:signal:clock:1.0 IBUF_OUT CLK";
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 156250000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN bd_ibufds_gt_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.bd_ibufds_gt_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
