...
module bd_v_mix_0_0_v_mix_422_to_444_false_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [10:0] lshr_ln58_cast_reg_219;
wire   [11:0] y_17_fu_177_p2;
reg   [11:0] y_17_reg_224;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln58_2_fu_183_p2;
wire   [10:0] x_17_fu_188_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state3) & ((1'd0 == and_ln58_reg_215) | (icmp_ln58_2_fu_183_p2 == 1'd1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state4))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln58_2_fu_183_p2 == 1'd0) & (1'd1 == and_ln58_reg_215))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd1 == and_ln58_fu_163_p2))) begin
        lshr_ln58_cast_reg_219 <= {{HwReg_layerWidth15_load_cast_loc_read_reg_205[11:1]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd1 == and_ln58_reg_215))) begin
        y_17_reg_224 <= y_17_fu_177_p2;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & ((1'd0 == and_ln58_reg_215) | (icmp_ln58_2_fu_183_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign and_ln58_fu_163_p2 = (p_read_reg_210 & icmp_ln58_fu_158_p2);
...
assign icmp_ln58_2_fu_183_p2 = ((y_reg_136 == HwReg_layerHeight18_load_cast_loc_read_reg_199) ? 1'b1 : 1'b0);

assign icmp_ln58_fu_158_p2 = ((HwReg_layerHeight18_load_cast_loc_read_reg_199 != 12'd0) ? 1'b1 : 1'b0);

assign icmp_ln60_fu_194_p2 = ((x_reg_147 == lshr_ln58_cast_reg_219) ? 1'b1 : 1'b0);
...
assign x_17_fu_188_p2 = (x_reg_147 + 11'd1);

assign y_17_fu_177_p2 = (y_reg_136 + 12'd1);

endmodule //bd_v_mix_0_0_v_mix_422_to_444_false_s
