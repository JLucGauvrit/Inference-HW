    ...
    reg ap_done_reg_0;// for module Block_split13_proc_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_0 <= 'b0;
        end
        else begin
            ap_done_reg_0 <= Block_split13_proc_U0.ap_done & ~Block_split13_proc_U0.ap_continue;
        end
    end

    reg ap_done_reg_1;// for module v_hcresampler_core15_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_1 <= 'b0;
        end
        else begin
            ap_done_reg_1 <= v_hcresampler_core15_U0.ap_done & ~v_hcresampler_core15_U0.ap_continue;
        end
    end

reg [15:0] trans_in_cnt_0;// for process v_hscaler_entry22_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (v_hscaler_entry22_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process v_hscaler_entry22_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (v_hscaler_entry22_U0.ap_done == 1'b1 && v_hscaler_entry22_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_1;// for process hscale_core_polyphase_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (hscale_core_polyphase_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process hscale_core_polyphase_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (hscale_core_polyphase_U0.ap_done == 1'b1 && hscale_core_polyphase_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_2;// for process v_csc_core_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_2 <= 16'h0;
    end
    else if (v_csc_core_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_2;// for process v_csc_core_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_2 <= 16'h0;
    end
    else if (v_csc_core_U0.ap_done == 1'b1 && v_csc_core_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_3;// for process Block_split13_proc_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_3 <= 16'h0;
    end
    else if (Block_split13_proc_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_3;// for process Block_split13_proc_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_3 <= 16'h0;
    end
    else if (Block_split13_proc_U0.ap_done == 1'b1 && Block_split13_proc_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_4;// for process v_vcresampler_core_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
...
reg [15:0] trans_out_cnt_4;// for process v_vcresampler_core_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
    ...
    // Process: v_hscaler_entry22_U0
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 0, 3, 3) bd_c2dc_hsc_0_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~v_hscaler_entry22_U0.ColorMode_out_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_Block_split12_proc_U0_U.if_full_n & v_hscaler_entry22_U0.ap_start & ~v_hscaler_entry22_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_Block_split12_proc_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0;
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~v_hscaler_entry22_U0.ColorMode_out1_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~start_for_AXIvideo2MultiPixStream_U0_U.if_full_n & v_hscaler_entry22_U0.ap_start & ~v_hscaler_entry22_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_AXIvideo2MultiPixStream_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (ap_sync_v_hscaler_entry22_U0_ap_ready & v_hscaler_entry22_U0.ap_idle & ~ap_sync_hscale_core_polyphase_U0_ap_ready);
    ...
    assign in_chan_dep_data_vec_0[29 : 20] = dep_chan_data_5_0;
    ...
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 1, 4, 2) bd_c2dc_hsc_0_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~Block_split12_proc_U0.ColorMode_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_Block_split12_proc_U0_U.if_empty_n & Block_split12_proc_U0.ap_idle & ~start_for_Block_split12_proc_U0_U.if_write);
    assign proc_1_TLF_FIFO_blk[0] = 1'b0;
    assign proc_1_input_sync_blk[0] = 1'b0;
    assign proc_1_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_1[0] = dl_detect_out ? proc_dep_vld_vec_1_reg[0] : (proc_1_data_FIFO_blk[0] | proc_1_data_PIPO_blk[0] | proc_1_start_FIFO_blk[0] | proc_1_TLF_FIFO_blk[0] | proc_1_input_sync_blk[0] | proc_1_output_sync_blk[0]);
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~Block_split12_proc_U0.ColorMode_out_blk_n);
    ...
    assign in_chan_dep_data_vec_1[39 : 30] = dep_chan_data_6_1;
    ...
    // Process: Block_split13_proc_U0
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 2, 3, 4) bd_c2dc_hsc_0_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_2_TLF_FIFO_blk[0] = 1'b0 | (~icmp_ln165_loc_channel_U.if_empty_n & Block_split13_proc_U0.ap_idle & ~icmp_ln165_loc_channel_U.if_write);
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~Block_split13_proc_U0.bPassThruCsc_out_blk_n);
    ...
    assign proc_2_data_FIFO_blk[2] = 1'b0 | (~Block_split13_proc_U0.bPassThruHcr2_out_blk_n);
    ...
    assign proc_2_data_FIFO_blk[3] = 1'b0 | (~Block_split13_proc_U0.bPassThruVcr_out_blk_n);
    assign proc_2_data_PIPO_blk[3] = 1'b0;
    assign proc_2_start_FIFO_blk[3] = 1'b0 | (~start_for_v_vcresampler_core_U0_U.if_full_n & Block_split13_proc_U0.ap_start & ~Block_split13_proc_U0.real_start & (trans_in_cnt_3 == trans_out_cnt_3) & ~start_for_v_vcresampler_core_U0_U.if_read);
    ...
    assign dep_chan_vld_2_8 = out_chan_dep_vld_vec_2[3];
    assign dep_chan_data_2_8 = out_chan_dep_data_2;
    assign token_2_8 = token_out_vec_2[3];

    // Process: AXIvideo2MultiPixStream_U0
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 3, 2, 2) bd_c2dc_hsc_0_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~AXIvideo2MultiPixStream_U0.stream_in_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~AXIvideo2MultiPixStream_U0.ColorMode_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0 | (~start_for_AXIvideo2MultiPixStream_U0_U.if_empty_n & AXIvideo2MultiPixStream_U0.ap_idle & ~start_for_AXIvideo2MultiPixStream_U0_U.if_write);
    ...
    // Process: v_hcresampler_core15_U0
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 4, 2, 3) bd_c2dc_hsc_0_hls_deadlock_detect_unit_4 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~v_hcresampler_core15_U0.srcImg_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~v_hcresampler_core15_U0.outImg_blk_n);
    ...
    assign proc_4_TLF_FIFO_blk[2] = 1'b0 | (~bPassThruHcr1_U.if_empty_n & v_hcresampler_core15_U0.ap_idle & ~bPassThruHcr1_U.if_write);
    ...
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 5, 3, 3) bd_c2dc_hsc_0_hls_deadlock_detect_unit_5 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~hscale_core_polyphase_U0.stream_upsampled_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~hscale_core_polyphase_U0.stream_scaled_blk_n);
    assign proc_5_data_PIPO_blk[1] = 1'b0;
    assign proc_5_start_FIFO_blk[1] = 1'b0 | (~start_for_v_csc_core_U0_U.if_full_n & hscale_core_polyphase_U0.ap_start & ~hscale_core_polyphase_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_v_csc_core_U0_U.if_read);
    ...
    assign proc_5_input_sync_blk[2] = 1'b0 | (ap_sync_hscale_core_polyphase_U0_ap_ready & hscale_core_polyphase_U0.ap_idle & ~ap_sync_v_hscaler_entry22_U0_ap_ready);
    ...
    assign in_chan_dep_data_vec_5[9 : 0] = dep_chan_data_0_5;
    ...
    assign in_chan_dep_data_vec_5[29 : 20] = dep_chan_data_6_5;
    ...
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 6, 4, 4) bd_c2dc_hsc_0_hls_deadlock_detect_unit_6 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~v_csc_core_U0.srcImg_blk_n);
    assign proc_6_data_PIPO_blk[0] = 1'b0;
    assign proc_6_start_FIFO_blk[0] = 1'b0 | (~start_for_v_csc_core_U0_U.if_empty_n & v_csc_core_U0.ap_idle & ~start_for_v_csc_core_U0_U.if_write);
    assign proc_6_TLF_FIFO_blk[0] = 1'b0;
    assign proc_6_input_sync_blk[0] = 1'b0;
    assign proc_6_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_6[0] = dl_detect_out ? proc_dep_vld_vec_6_reg[0] : (proc_6_data_FIFO_blk[0] | proc_6_data_PIPO_blk[0] | proc_6_start_FIFO_blk[0] | proc_6_TLF_FIFO_blk[0] | proc_6_input_sync_blk[0] | proc_6_output_sync_blk[0]);
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~v_csc_core_U0.colorMode_blk_n);
    ...
    assign proc_6_data_FIFO_blk[2] = 1'b0 | (~v_csc_core_U0.outImg_blk_n);
    assign proc_6_data_PIPO_blk[2] = 1'b0;
    assign proc_6_start_FIFO_blk[2] = 1'b0 | (~start_for_v_hcresampler_core_U0_U.if_full_n & v_csc_core_U0.ap_start & ~v_csc_core_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_v_hcresampler_core_U0_U.if_read);
    assign proc_6_TLF_FIFO_blk[2] = 1'b0;
    assign proc_6_input_sync_blk[2] = 1'b0;
    assign proc_6_output_sync_blk[2] = 1'b0;
    assign proc_dep_vld_vec_6[2] = dl_detect_out ? proc_dep_vld_vec_6_reg[2] : (proc_6_data_FIFO_blk[2] | proc_6_data_PIPO_blk[2] | proc_6_start_FIFO_blk[2] | proc_6_TLF_FIFO_blk[2] | proc_6_input_sync_blk[2] | proc_6_output_sync_blk[2]);
    assign proc_6_data_FIFO_blk[3] = 1'b0 | (~v_csc_core_U0.bPassThru_blk_n);
    ...
    assign in_chan_dep_data_vec_6[9 : 0] = dep_chan_data_1_6;
    assign token_in_vec_6[0] = token_1_6;
    assign in_chan_dep_vld_vec_6[1] = dep_chan_vld_2_6;
    assign in_chan_dep_data_vec_6[19 : 10] = dep_chan_data_2_6;
    ...
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 7, 3, 3) bd_c2dc_hsc_0_hls_deadlock_detect_unit_7 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_7_start_FIFO_blk[0] = 1'b0 | (~start_for_v_hcresampler_core_U0_U.if_empty_n & v_hcresampler_core_U0.ap_idle & ~start_for_v_hcresampler_core_U0_U.if_write);
    ...
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 8, 3, 3) bd_c2dc_hsc_0_hls_deadlock_detect_unit_8 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_8_start_FIFO_blk[1] = 1'b0 | (~start_for_MultiPixStream2AXIvideo_U0_U.if_full_n & v_vcresampler_core_U0.ap_start & ~v_vcresampler_core_U0.real_start & (trans_in_cnt_4 == trans_out_cnt_4) & ~start_for_MultiPixStream2AXIvideo_U0_U.if_read);
    ...
    assign in_chan_dep_data_vec_8[9 : 0] = dep_chan_data_2_8;
    ...
    bd_c2dc_hsc_0_hls_deadlock_detect_unit #(10, 9, 1, 1) bd_c2dc_hsc_0_hls_deadlock_detect_unit_9 (
        .reset(reset),
        .clock(clock),
...
`include "bd_c2dc_hsc_0_hls_deadlock_report_unit.vh"
